...
const IngredientList = ({ ingredients, onRemove }) => {
  return (
    <div className="flex mb-[6.4rem] tablet:mb-[8rem] gap-[1.6rem] flex-wrap">
      {ingredients.map((ing, index) => (
        <div key={index} className="flex gap-[1rem] items-center ">
          <div
            className="w-[7.5rem] h-[7.5rem] rounded-[1.5rem] border  border-(--grey) 
          ...
          <div className="flex items-center w-[7.5rem] h-[7.5rem] relative">
            <button
              type="button"
